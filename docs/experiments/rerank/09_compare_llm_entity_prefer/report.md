...
- compare 策略：hybrid_top20 + llm_rewrite_separate_subquery_top8 + per_query_keep2 + entity_prefer + rerank_top5 + parent_window
...
- `compare_007` compare coverage=1/2
  ...
  top_sources: ['data/raw/healthcare/KLY.pdf', 'data/raw/healthcare/PRYK.pdf', 'data/raw/semiconductor/TJKJ.pdf']
...
- `compare_010` compare coverage=1/2
  ...
  top_sources: ['data/raw/healthcare/BTGF.pdf', 'data/raw/healthcare/YMKD.pdf', 'data/raw/healthcare/TGYY.pdf']
