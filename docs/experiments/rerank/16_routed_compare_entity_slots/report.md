...
- compare 策略：hybrid_top20 + llm_rewrite_separate_subquery_top8 + per_query_keep2 + coarse_to_fine_doc_top2_adaptive3_page_top12_keep4 + entity_slot2 + entity_prefer + rerank_top5 + parent_fill_pool12 + parent_window
...
- `compare_008` compare coverage=1/2
  ...
  top_sources: ['data/raw/healthcare/YKSW.pdf', 'data/raw/healthcare/TCYL.pdf', 'data/raw/healthcare/BAST.pdf']
- `compare_021` compare coverage=1/2
  query: 华源控股 vs 海光信息，哪家公司2026年Q1实现营收更高
  top_sources: ['data/raw/semiconductor/HYKG.pdf', 'data/raw/semiconductor/BDT.pdf']
