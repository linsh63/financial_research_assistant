...
- compare rewrite：`data/processed/query_rewrites/compare_gpt54mini.jsonl`
- 父文档窗口：前后各 1 页
- fact 策略：hybrid_top5 + parent_window
- compare 策略：hybrid_top20 + llm_rewrite_separate_subquery_top8 + per_query_keep2 + rerank_top5 + parent_window
...
|---|---:|---:|---:|---:|---:|---:|
| routed | 93.24% | 94.68% | 98.33% | 98.33% | 87.50% | 90.83% |
...
- `compare_003` compare coverage=1/2
  ...
  top_sources: ['data/raw/consumer/QHWY.pdf', 'data/raw/consumer/AQJM.pdf', 'data/raw/semiconductor/TJKJ.pdf']
- `compare_007` compare coverage=1/2
  query: 普蕊斯 vs 普瑞眼科，预计哪家公司在2026年的营收更高
  top_sources: ['data/raw/healthcare/KLY.pdf', 'data/raw/healthcare/AEYK.pdf', 'data/raw/semiconductor/TJKJ.pdf', 'data/raw/healthcare/PRYK.pdf']
- `compare_008` compare coverage=1/2
  query: 昭衍新药 vs 通策医疗，预计哪家公司在2026年的营收更高
  top_sources: ['data/raw/healthcare/SYXY.pdf', 'data/raw/healthcare/YKSW.pdf', 'data/raw/healthcare/BTGF.pdf']
- `compare_024` compare coverage=1/2
  query: 拓荆科技 vs 中科曙光，哪家公司2026年Q1实现营收更高
  top_sources: ['data/raw/new_energy/宁德时代_202601.pdf', 'data/raw/semiconductor/ZKSG.pdf', 'data/raw/new_energy/赛力斯_202601.pdf']
