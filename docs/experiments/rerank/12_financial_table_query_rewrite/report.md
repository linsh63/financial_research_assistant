...
- compare rewrite：`data/processed/query_rewrites/compare_financial_table_rule.jsonl`
- 父文档窗口：前后各 1 页
...
- `compare_007` compare coverage=1/2
  ...
  top_sources: ['data/raw/healthcare/GJYX.pdf', 'data/raw/healthcare/PRYK.pdf', 'data/raw/healthcare/HXYK.pdf', 'data/raw/healthcare/AEYK.pdf']
- `compare_008` compare coverage=0/2
  query: 昭衍新药 vs 通策医疗，预计哪家公司在2026年的营收更高
  top_sources: ['data/raw/healthcare/YKSW.pdf', 'data/raw/healthcare/PRYK.pdf', 'data/raw/real_estate/CJFZ.pdf']
