...
- compare 策略：hybrid_top20 + llm_rewrite_separate_subquery_top8 + per_query_keep2 + entity_prefer + rerank_top5 + parent_fill_pool12 + parent_window
...
|---|---:|---:|---:|---:|---:|---:|
| routed | 93.65% | 95.10% | 98.33% | 98.33% | 88.33% | 91.67% |
...
- `compare_003` compare coverage=1/2
  ...
  top_sources: ['data/raw/consumer/QHWY.pdf', 'data/raw/consumer/AQJM.pdf', 'data/raw/semiconductor/TJKJ.pdf', 'data/raw/consumer/HTWY.pdf', 'data/raw/consumer/AJSP.pdf']
- `compare_007` compare coverage=1/2
  query: 普蕊斯 vs 普瑞眼科，预计哪家公司在2026年的营收更高
  top_sources: ['data/raw/healthcare/KLY.pdf', 'data/raw/healthcare/PRYK.pdf', 'data/raw/semiconductor/TJKJ.pdf', 'data/raw/healthcare/HXYK.pdf', 'data/raw/healthcare/AEYK.pdf']
