...
- compare 策略：hybrid_top20 + entity_top8 + rerank_top5 + parent_window
...
|---|---:|---:|---:|---:|---:|---:|
| routed | 92.82% | 94.26% | 98.33% | 98.33% | 86.67% | 90.00% |
...
- `compare_008` compare coverage=1/2
  ...
  top_sources: ['data/raw/healthcare/SYXY.pdf', 'data/raw/healthcare/YKSW.pdf']
- `compare_010` compare coverage=1/2
  query: 药康生物 vs 药明康德，哪家公司2025年的全年营业收入同比增长更多
  top_sources: ['data/raw/healthcare/YMKD.pdf', 'data/raw/healthcare/TGYY.pdf', 'data/raw/healthcare/BTGF.pdf']
