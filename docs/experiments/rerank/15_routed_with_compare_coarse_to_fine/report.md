...
- compare 策略：hybrid_top20 + llm_rewrite_separate_subquery_top8 + per_query_keep2 + coarse_to_fine_doc_top2_adaptive3_page_top12_keep4 + entity_prefer + rerank_top5 + parent_fill_pool12 + parent_window
...
|---|---:|---:|---:|---:|---:|---:|
| routed | 94.07% | 95.51% | 97.50% | 97.50% | 90.00% | 93.33% |
